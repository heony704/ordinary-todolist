...
export default function TodolistPage() {
  return (
    <div className="flex flex-col items-center px-6 max-w-3xl mx-auto">
      <div className="flex items-center py-6 text-2xl font-semibold text-gray-900 dark:text-white">
        Todolist
      </div>
